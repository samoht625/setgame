...
export class MultiplayerSetGame {
    ...
    // DOM elements
    private joinForm!: HTMLElement;
    private overlay!: HTMLElement;
    private gameContent!: HTMLElement;
    private playerNameInput!: HTMLInputElement;
    private joinButton!: HTMLButtonElement;
    private currentPlayerName!: HTMLElement;
    private setsCountElement!: HTMLElement;
    private totalWinsElement!: HTMLElement;
    private deckRemainingElement!: HTMLElement;
    ...
    private initializeUI(): void {
        ...
        this.joinButton = document.getElementById('join-btn')! as HTMLButtonElement;
    ...
    private handleSetFound(data: { playerName: string; playerId: number }): void {
